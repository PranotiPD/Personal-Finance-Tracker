...
def add():
    CSV.initialize_csv()
    date = get_date("Enter the date of transaction (dd-mm-yyyy) or just press enter to add today's date", allow_defaults=True)
    amount = get_amount()
...
def main():
    while True:
        ...
        print("2. View transactions with overall summary in date range")
        print("3. Exit")
        ...
        if choice == "1":
            ...
            if not df.empty and input("Do you want to see plot? (y/n): ").lower() == "y":
